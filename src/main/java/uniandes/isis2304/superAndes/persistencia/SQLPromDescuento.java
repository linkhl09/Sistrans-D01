...
public class SQLPromDescuento 
{
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la informaci贸n de UN PromDescuento de la 
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la informaci贸n de LOS PromDescuento de la 
