...
public class PersistenciaSuperAndes {
	 ...
	 * @param fechaFin --Rango de fechas de la busqueda (final del rango)
	 *  */
	public List<Cliente> darOrdenadoPuntosClientesRealizaronCompra( String codigoProducto, String fechaInicio, String  fechaFin)
	{
		return sqlCliente.ordenarPorPuntosR10(pmf.getPersistenceManager(), codigoProducto, fechaInicio, fechaFin);
	}
	/**
	 * Devuelve a todos los clientes que realizaron al menos una compra de un producto especifico
	 * en un rango de fechas
	 ...
	 * @param fechaFin --Rango de fechas de la busqueda (final del rango)
	 *  */
	public List<Cliente> darOrdenadoFechasClientesRealizaronCompra( String codigoProducto, String fechaInicio, String  fechaFin)
	{
		return sqlCliente.ordenarPorFechaR10(pmf.getPersistenceManager(), codigoProducto, fechaInicio, fechaFin);
	}
	/**
	 * Devuelve a todos los clientes que realizaron al menos una compra de un producto especifico
	 * en un rango de fechas
	 ...
	 * @param fechaFin --Rango de fechas de la busqueda (final del rango)
	 *  */
	public List<Cliente> darOrdenadosCantidadClientesRealizaronCompra( String codigoProducto, String fechaInicio, String  fechaFin)
	{
