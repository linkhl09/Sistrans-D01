...
public class SQLPromPagLleveCatidad 
{
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de UN PromPagLleveCatidad de la 
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la información de LOS PromPagLleveCatidad de la 
