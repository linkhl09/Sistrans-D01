...
/**
 * Clase que encapsula los m閠odos que hacen acceso a la base de datos para el concepto PROM PAG LLEV UNIDAD 
...
public class SQLPromPagLlevUnidad
{
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la informaci贸n de UN PromPagLlevUnidad de la 
	...
	/**
	 * Crea y ejecuta la sentencia SQL para encontrar la informaci贸n de LOS PromPagueLleveUnid de la 
