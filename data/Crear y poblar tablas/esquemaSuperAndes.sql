...
--Creación Tabla TIPO_CATEGORIA
CREATE TABLE TIPO_CATEGORIA
    (
     NOMBRETIPO VARCHAR2(100 BYTE),
     NOMBRECATEGORIA VARCHAR2(100 BYTE),

     CONSTRAINT TIPO_CATEGORIA_PK PRIMARY KEY (NOMBRETIPO,NOMBRECATEGORIA)
    );
...
CREATE TABLE SUCURSAL_PRODUCTO
    ...
    CONSTRAINT SUCURSAL_PRODUCTO_PK PRIMARY KEY (PRODUCTO, IDSUCURSAL)
    );
...
ALTER TABLE ESTANTE
    ...
    FOREIGN KEY (IDSUCURDSAL) REFERENCES SUCURSAL(ID)
    ON DELETE CASCADE
    ENABLE;
ALTER TABLE ESTANTE
...
CREATE TABLE PRODUCTO_CARRITOCOMPRAS
    ...
    CANTIDAD NUMBER,
    CODIGOBARRAS VARCHAR2(13 BYTE),
    CONSTRAINT CARRITOCOMPRAS_PK PRIMARY KEY (CARRITO, CODIGOBARRAS)
    );
