...
ALTER TABLE PRODUCTO
    ...
    ENABLE;
ALTER TABLE PRODUCTO
    ADD CONSTRAINT promocion_valida
    CHECK(ESTAPROMOCION = 0 OR ESTAPROMOCION = 1)
    ENABLE;
...
ALTER TABLE PERSONANATURAL
    ...
    CHECK (TIPODOCUMENTO IN ('CI', 'DUI', 'ID', 'CC', 'TI', 'TD', 'RC', 'CE', 'CI', 'DNI'));
...
CREATE TABLE PROVEEDOR
    ...
    CALIFICACIONCALIDAD NUMBER(*,1) NOT NULL,
...
CREATE TABLE ORDENPEDIDO
    ...
    CALIFICACIONPROVEEDOR NUMBER(*,1) NOT NULL,
...
--FIN DE CREACIÓN DE LAS 25 TABLAS, COMMIT
COMMIT; 