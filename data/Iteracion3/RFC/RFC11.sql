--los usuarios que NO realizaron al menos una compra de un determinado
--producto en un rango de fechas

SELECT *
FROM
(select * from cliente) minus(
 select correoelectronico, nombre, puntos,empresa,documentopn
